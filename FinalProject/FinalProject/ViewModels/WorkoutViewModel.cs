...
namespace FinalProject.ViewModels
{
    public class WorkoutViewModel : BindableBase, INavigatedAware
    {
        ...
        private void Populate()
        {
            ...
            _WorkoutCollection.Add(new WorkoutItem { Details = "WORKOUTS", URL = "NONE" , MDetails = "Workouts composed of sets of exercises from the list. Each set contains multiple repetitions of 1 exercise and combines multiple exercises." });
